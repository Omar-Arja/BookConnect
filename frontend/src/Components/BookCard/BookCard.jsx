...
const BookCard = ({ book }) => {
    ...
    const { _id, title, author, genre, review, pic_url, username, isLiked, likeCount } = book;
            ...
            <div className="book-content">
                ...
                <div className="book-actions">
                    <button className="like-button" onClick={handleLike}>
                        {liked ? <AiTwotoneHeart className="like-button-red" /> : <AiOutlineHeart className="like-button-empty" />}
                        {likes} Likes
                    </button>
